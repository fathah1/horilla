...
@method_decorator(
    permission_required("terrain_automations.view_mailautomation"), name="dispatch"
)
...
class AutomationNavView(views.HorillaNavView):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("terrain_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("terrain_automations.change_mailautomation"), name="dispatch"
)
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("terrain_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "terrain_automations/load_automation.html"
